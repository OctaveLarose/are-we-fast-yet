...
node_int_data <- load_data_url("https://rebench.stefan-marr.de/Are-We-Fast-Yet/data/3219")
interp_data <- rbind(interp_data %>% filter(exe != "Node-int"), load_data_url("https://rebench.stefan-marr.de/Are-We-Fast-Yet/data/3219"))
